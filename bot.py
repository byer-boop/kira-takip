...
async def listele(update: Update, context: ContextTypes.DEFAULT_TYPE):
   ...
   for k in kiracılar:
       ...
       mesaj = mesaj + k["ad"] + " " + k["soyad"] + " - Daire " + k["daire"] + "\n" + str(int(k["kira"])) + " GBP | " + str(k["odeme_gunu"]) + ". gun | " + durum + "\n\n"
   keyboard = [[InlineKeyboardButton("Ana Menu", callback_data="ana_menu")]]
...
async def rapor(update: Update, context: ContextTypes.DEFAULT_TYPE):
   ...
   mesaj = "Rapor - " + datetime.now().strftime("%B %Y") + "\n\nToplam kiraci: " + str(toplam) + "\nOdeme yapan: " + str(odenenler) + "\nOdeme yapmayan: " + str(toplam - odenenler) + "\n\nBeklenen: " + str(int(toplam_kira)) + " GBP\nToplanan: " + str(int(toplanan)) + " GBP\nBekleyen: " + str(int(toplam_kira - toplanan)) + " GBP"
   keyboard = [[InlineKeyboardButton("Ana Menu", callback_data="ana_menu")]]
   await query.edit_message_text(mesaj, reply_markup=InlineKeyboardMarkup(keyboard))
